...
{
    public class Patch_Building_PawnVatGrower : IModCompatibilityPatchComponent
    {
        public override string ComponentName => "Patch Pawn Vat Grower to actuate standby";

        public override string TypeNameToPatch => "Building_PawnVatGrower";
        ...
        public override IEnumerable<PatchInfo> GetPatches(Type type)
        {
            ...
            patches.Add(new PatchInfo()
            {
                ...
                patch = GetMethod<Patch_Building_PawnVatGrower>(nameof(Postfix)),
