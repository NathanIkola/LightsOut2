...
{
    public class Patch_Building_CustomDroidCrafter : IModCompatibilityPatchComponent
    {
        public override string ComponentName => "Patch Custom Droid Crafter to actuate standby";

        public override string TypeNameToPatch => "Building_CustomDroidCrafter";
